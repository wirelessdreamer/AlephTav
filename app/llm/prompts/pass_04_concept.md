...
Use the project's completed Psalm lyric drafts as style references only: ordinary speech, direct address, concrete image pressure, emotional readability, and no pseudo-biblical filler.
Do not copy those lyrics or treat them as source witnesses.
Concept candidates should feel usable by a lyric writer: smooth stacked source metadata, preserve source agency, and make each alternate materially distinct.
